...
namespace ProiectFacultativ.consoleInterface
{
    internal class Interface<ID>
    {
        ...
        private void Task4()
        {
            ...
            {
                Console.WriteLine("Nu ati furnizat un id numeric!");
            }
        }
        ...
        private void Run()
        {
            ...
            Console.WriteLine("Apasati Enter pentru afisarea meniului!");
            while (true)
            {
                Console.Write(">>");
                ...
                switch (option)
                {
                    ...
                    case "0" or "exit":
                        ...
                        return;
                    default:
                        taskExecuter = new executeTaskDelegate(Meniu);
                        break;
                }
                taskExecuter();
            }
