...
import com.example.temasaptamana5.repository.interfaces.IShowRepository;
...
public class ShowDBIRepository extends ConcreteObservable<ActualEvent> implements IShowRepository<Integer, Show> {
    ...
    public Iterable<ShowDTO> getAllShows() {
