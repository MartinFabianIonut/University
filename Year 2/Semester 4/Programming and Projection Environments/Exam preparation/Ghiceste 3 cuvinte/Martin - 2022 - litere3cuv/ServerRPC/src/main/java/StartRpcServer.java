...
public class StartRpcServer {
    ...
    public static void main(String[] args) {
        ...
        IScoreRepository<Integer, Score> moveRepository = new ScoreDBIRepository(serverProps,playerRepository,gameRepository);
        IService serverImpl=new ServicesImpl(playerRepository, gameRepository, moveRepository);
