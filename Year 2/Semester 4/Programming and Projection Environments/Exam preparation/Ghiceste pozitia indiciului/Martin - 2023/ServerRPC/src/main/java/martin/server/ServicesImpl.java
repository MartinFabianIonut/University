...
public class ServicesImpl implements IService {
    ...
    public Iterable<DTO> getRanking() {
        ...
        return scores.stream()
                ...
                .map(score -> new DTO(score.getPlayer(), score.getTime(), score.getAttempts(), score.getText()))
                .sorted(Comparator.comparing(DTO::getGuessings).thenComparing(DTO::getTime))
