...
import com.example.temasaptamana5.repository.interfaces.ITicketRepository;
...
import com.example.temasaptamana5.utils.utils.ChangeEventType;
...
public class TicketDBIRepository extends ConcreteObservable<ActualEvent> implements ITicketRepository<Integer, Ticket> {
    ...
    public void addTicket(Ticket ticket) {
        ...
        this.notifyObservers(new ActualEvent(ChangeEventType.ADD,null,null,null,ticket));
    }
}
