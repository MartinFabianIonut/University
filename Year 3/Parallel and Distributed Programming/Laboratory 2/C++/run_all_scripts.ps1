...
$dynamicParallelRows = $dynamicParallel + "\main.exe"
...
$scriptOrder = @(
    ...
    @{ Script = $dynamicParallelScript; Params = @($dynamicParallelRows, "N=M=10 si n=m=3", "2", "10", "10", "10", "3") } , # 4 threads, 10 runs, 10 rows, 10 cols, 3 rows/cols convolution matrix
