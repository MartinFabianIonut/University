...
//int main()
//{
//	omp_set_num_threads(4); // setam nr. de thread-uri pe care, ulterior, le va crea OpenMP - NU AICI SE CREEAZA THREAD-URILE!
//
...
//
//		// schedule(static) - se distribuie n/p , iar ultimul thread va avea mai multe eventual
//		// schedule(dynamic) - se distribuie cate un chunk de la fiecare thread, dar nu neaparat in ordine (chunck 1 - t1, chunk 2 - t2, etc... - nu neaparat in ordine)
//		// schdule ( static, 2) - se distribuie cate 2 elemente la fiecare thread, apoi se da ciclic la fiecare thread
//		// schedule (dynamic, 2) - se distribuie cate 2 elemente la fiecare thread, apoi se da ciclic la fiecare thread fara ordine
//
...
//		{
//#pragma omp section // cate un thread executa un section, deci avem 3 sections => 3 thread-uri folosite, 5 nu sunt folosite
//			{
//				addVectors(a, b, c);
//#pragma omp critical
//				{
...
//#pragma omp critical
//				{
//					cout << "Section produs: " << omp_get_thread_num() << endl; // cout nu e thread safe, deci trebuie sa punem critical
//				}
//			}
//		}
//	}
