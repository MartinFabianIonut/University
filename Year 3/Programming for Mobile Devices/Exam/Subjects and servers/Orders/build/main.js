...
const menuItems = Array.from(Array(10).keys()).map(code => ({
  code,
  name: `p${code}`
}));
...
module.exports = __webpack_require__(/*! C:\GIT\University\Year 3\Programming for Mobile Devices\Exam\Subjects and servers\Orders\src/index.js */"./src/index.js");
