...
router.get('/note', ctx => {
  ...
  if (ifModifiedSince && new Date(ifModifiedSince).getTime() >= lastUpdated.getTime() - lastUpdated.getMilliseconds()) {
    ...
    const notesCopy = notes.map(note => _objectSpread({}, note));
...
module.exports = __webpack_require__(/*! C:\GIT\University\Year 3\Programming for Mobile Devices\Exam\Subjects and servers\Note\src/index.js */"./src/index.js");
