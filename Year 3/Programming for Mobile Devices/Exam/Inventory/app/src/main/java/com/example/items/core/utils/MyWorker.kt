...
class MyWorker(
    ...
    override suspend fun doWork(): Result {
        val productDao = ItemStoreAndroidDatabase.getDatabase(applicationContext).productDao()
        val dirtyItems = productDao.getDirtyItems()
...
//                )
//                Thread.sleep(1000)
//                productDao.deleteItem(dirtyItem)
