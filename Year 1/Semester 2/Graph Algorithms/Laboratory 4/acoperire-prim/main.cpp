...
struct Compara
{
    bool operator()(const prim &p1, prim const &p2)
    {
...
int main()
{
    ...
    // Using vectors instead of arrays for dynamic memory allocation
    ...
    std::sort(coada.begin(), coada.end(), [](const prim &a, const prim &b)
